...
//  LAUNCH 
    ...
    async login(page: Page): Promise<Page>{
        try {
            ...
            await page.waitForSelector('#nav-employer > div > div.col-sm-12.col-lg-5.td_col-left.td_col > div > form > div:nth-child(2) > input');
            await page.type('#nav-employer > div > div.col-sm-12.col-lg-5.td_col-left.td_col > div > form > div:nth-child(2) > input',"taintse140073@fpt.edu.vn");
            await page.waitForSelector('#nav-employer > div > div.col-sm-12.col-lg-5.td_col-left.td_col > div > form > div:nth-child(3) > input');
            await page.type('#nav-employer > div > div.col-sm-12.col-lg-5.td_col-left.td_col > div > form > div:nth-child(3) > input',"78945613qE");
			await page.waitForTimeout(3000);
            await page.waitForSelector('#nav-employer > div > div.col-sm-12.col-lg-5.td_col-left.td_col > div > form > button');
            await page.click('#nav-employer > div > div.col-sm-12.col-lg-5.td_col-left.td_col > div > form > button');
	...
	async crawlJobDetail(page: Page, job: JobOverallDTO): Promise<JobDetailDTO>{
		try {
			...
			// Adress
			await page.waitForSelector('#slide-wrap-length > div.right-cont > div.fixed_scroll > div:nth-child(2) > div:nth-child(3) > p');
			...
			// region 
			let tempRegion = "";
			if(workAddress.includes("Hồ Chí Minh")){ tempRegion = " Hồ Chí Minh";}
			else if(workAddress.includes("Hà Nội")){ tempRegion = "Hà Nội";}
			else if(workAddress.includes("Đà Nẵng")) {tempRegion = "Đà Nẵng";}
			else{ tempRegion = "viet nam";}
			const region = tempRegion;
			this.log('info',`Raw region: ${region}`);
			//salary
			await page.waitForSelector('#about_company > div.mb-3.job-salary-view.custom_salary_job_detail.js-job-salary-view > span');
			...
			//level
			await page.waitForSelector('#slide-wrap-length > div.right-cont > div.fixed_scroll > div:nth-child(2) > p:nth-child(7)');
			...
			//work method
			await page.waitForSelector('#slide-wrap-length > div.right-cont > div.fixed_scroll > div:nth-child(2) > div:nth-child(9) > div > div > a > span');
			...
			//skill
			await page.waitForSelector('#slide-wrap-length > div.right-cont > div.fixed_scroll > div:nth-child(2) > div.mb-3.lang-badge-light.job-bottom.custom__over_hidden > div > a');
			const skills = await page.$$eval('#slide-wrap-length > div.right-cont > div.fixed_scroll > div:nth-child(2) > div.mb-3.lang-badge-light.job-bottom.custom__over_hidden > div > a', (els) => {
			...
			// Exp
			await page.waitForSelector('#slide-wrap-length > div.right-cont > div.fixed_scroll > div:nth-child(2) > p:nth-child(5)');
	...
	async crawlCompany(page: Page, companyLink: string): Promise<CompanyDTO> {
		try {
			...
			await page.waitForTimeout(3000);
			await page.waitForSelector('#scroll_loading_detail > div > div > div.col-12.col-xl-9.leftside > div > div.box.about-comp > div > div > h1');
			const companyName = await page.$eval(
				'#scroll_loading_detail > div > div > div.col-12.col-xl-9.leftside > div > div.box.about-comp > div > div > h1',
				(el) => (el as HTMLElement).innerText
			);
			await page.waitForSelector('#scroll_loading_detail > div > div > div.col-12.col-xl-3.rightside > div > div:nth-child(4) > p:nth-child(1)');
			...
			await page.waitForSelector('#scroll_loading_detail > div > div > div.col-12.col-xl-9.leftside > div > div.box.about-comp > div > p > img');
			const companyImageUrl =
				(await page.$eval('#scroll_loading_detail > div > div > div.col-12.col-xl-9.leftside > div > div.box.about-comp > div > p > img', (el) =>
